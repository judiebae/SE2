...
function handleRegister($conn) {
    ...
    // Change c_email to customer_email
    ...
    $stmt = $conn->prepare("INSERT INTO Customer (customer_first_name, customer_last_name, customer_email, customer_contact_number, customer_password) VALUES (:firstName, :lastName, :email, :contactNumber, :password)");
...
function handleLogin($conn) {
    try {
        ...
        $stmt = $conn->prepare("SELECT customer_id, customer_password FROM Customer WHERE customer_email = ?");
        $stmt->execute([$email]);
